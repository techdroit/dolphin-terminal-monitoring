<div class="static-content-wrapper">
			...
			<div class="container-fluid">
				...
				<div data-widget-group="group1">
					...
					<div class="panel panel-default"
						...
						<div class="panel-body">
							<form action="" class="form-horizontal row-border">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">With pre-defined
										value</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<label class="checkbox icheck"> <input type="checkbox"
											value=""> Option one is this and that
										</label> <label class="checkbox icheck"> <input
											type="checkbox" value=""> Option two can be something
											else
										</label>
						...
						<div class="panel-body">
							...
							<div class="alert alert-info">
								...
								<p>Super customized checkbox and radio buttons that are
									backward compatible and appears identical in both desktop and
									mobile.</p>
							</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<h3>
										Minimal Skin <small>Default - <em>Customized for
												Avenger</em></small>
									</h3>
									<div class="row">
								...
								<div class="col-sm-4">
									...
									<div class="row">
										...
										<div class="col-sm-6 icheck-flat">
											<div class="radio red icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option1" checked>Red</label>
											</div>
											<div class="radio green icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option2">Green</label>
											</div>
											<div class="radio aero icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option2">Aero</label>
											</div>
											<div class="radio blue icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option2">Blue</label>
											</div>
											<div class="radio grey icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option2">Grey</label>
											</div>
											<div class="radio orange icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option2">Orange</label>
											</div>
											<div class="radio pink icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option2">Pink</label>
											</div>
											<div class="radio purple icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option2">Purple</label>
											</div>
											<div class="radio yellow icheck">
												<label><input type="radio" name="optionsRadios-flat"
													value="option2">Yellow</label>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-sm-8">
										<ul class="demo-btns mb-10">
											...
											<li><input class="bootstrap-switch" type="checkbox"
												...
												data-off-color="default" /></li>
											<li><input class="bootstrap-switch" type="checkbox"
												data-on-text="1" data-on-color="success" data-off-text="0"
												data-off-color="danger" /></li>
											<li><input class="bootstrap-switch" type="checkbox"
					...
					<div class="panel panel-default"
						...
						<div class="panel-body">
							<form action="" class="form-horizontal row-border">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">Buttons instead
										of text</label>
									<div class="col-sm-8">
										<div class="input-group">
											<input type="text" class="form-control">
						...
						<div class="panel-body">
							<div class="col-12">
								<p>A fast, full-featured, autocomplete library can prefet
									data, search that data on the client, and then falling back to
									the server. Powered by Twitter Typeahead.</p>
							</div>
							<form action="" class="form-horizontal row-border">
								<div class="form-group">
						...
						<div class="panel-body">
							<form action="" class="form-horizontal row-border">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<p class="help-block">Supports a minimum input setting
											which is useful for large remote datasets where short search
											terms are not very useful</p>
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 control-label">Infinite Scroll
										with Remote Data</label>
									<div class="col-sm-8">
										<input type="hidden" id="e7" style="width: 100% !important" />
										<p class="help-block">The selectbox has AJAX/JSONP support
											built in. In this example we will search for a movie using
											Rotten Tomatoes API. When result-list is scrolled to an end,
											more results are lazy-appended</p>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="hidden" id="e12" style="width: 100% !important"
					...
					<div class="panel panel-default"
						...
						<div class="panel-editbox" data-widget-controls=""></div>
						<div class="panel-body">
							<p>Advanced tagging/tokenizing plugin for input fields with a
								focus on keyboard and copy-paste support.</p>
							<form action="" class="form-horizontal row-border">

								<div class="form-group">
									<label class="col-sm-2 control-label">Using jQuery UI
										Autocomplete</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="tokenfield-jQUI"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="input-group">
											<input type="text" class="form-control" id="tokenfield-email"
												value="one@email.com,not an email, another@email.com" /> <span
					...
					<div class="panel panel-default"
						...
						<div class="panel-body">
							...
							<form action="" class="form-horizontal row-border">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">Multiple Select
										with Search and Group select</label>
									<div class="col-sm-8">
							...
							<div class="alert alert-info">
								...
								<p>
									...
									<code>select</code>
									s plugin. Use <i>class based</i> version if you do not want to
									make external queries. A separate version that supports remote
									selects from <i>AJAX queries</i> is also included.
								</p>
							</div>
					...
					<div class="panel panel-default"
						...
						<div class="panel-body">
							<div class="alert alert-info">
								...
								<p>Card will take any credit card form and make it the best
									part of the checkout process (without you changing anything).
									Everything is created with pure CSS, HTML, and Javascript —
									no images required.</p>
							</div>
							<div class="row">
								<div class="col-sm-6">
						...
						<div class="panel-body">
							<form action="" class="form-horizontal row-border">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<div class="fileinput fileinput-new" style="width: 100%;"
											...
											<div class="fileinput-preview thumbnail mb20"
												data-trigger="fileinput" style="width: 100%; height: 150px;"></div>
											<div>
									...
									<div class="col-sm-4">
										<div class="alert alert-info">Image preview only works
											in IE10+, FF3.6+, Safari6.0+, Chrome6.0+ and Opera11.1+. In
											older browsers the filename is shown instead.</div>
									</div>
								</div>
					...
					<div class="panel panel-default"
						...
						<div class="panel-editbox" data-widget-controls=""></div>
						<div class="panel-body">
							<div class="alert alert-info">A mobile and touch friendly
								input spinner component for Avenger. It supports the mousewheel
								and the up/down keys.</div>
							<form action="" class="form-horizontal row-border">
								<div class="form-group">
	...
	<%@include file="altavizs-template-footer.jsp" %>
</div>